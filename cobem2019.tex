...
\\
\abstract{\textbf{Abstract.} The abstract should describe the objectives, the methodology and the main conclusions (or expected conclusions) of the work in about 200 words. It should not contain neither formulae nor reference to bibliography.}\\
\\
\keywords{\textbf{Keywords:} naval propulsion, hybrid systems, Petri Nets, Objected Oriented Predicate Transition Differential Nets}\\
\end{tabular}
